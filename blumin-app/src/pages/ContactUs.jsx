...
const ContactUs = () => {
    return (
        <>
            <section className="text-gray-600 body-font py-10"> {/* Added more padding above and below */}
                <div className="container px-5 mx-auto">
                    <h1 className="text-6xl font-medium title-font text-gray-900 mb-12 text-center">CONTACT</h1>
                </div>
            </section>
                    ...
                    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                        ...
                        <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                            <div className="lg:w-1/2 px-6">
                                ...
                                <p className="mt-1">Fourth floor, Syncor Solutions, Jyothi Imperial, Gachibowli, Hyderabad.</p>
                            </div>
